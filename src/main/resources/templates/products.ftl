...
<div id="box2">
    ...
    <div class="container">
        <div class="row">
            <div class="col-4">
                <div style="color:white; position: fixed; padding:1%; border: 4px solid #f0dd24;">
                    <h4>Your cart</h4>
                    ...
                    <div>
                        <li class="media" id="product4">
                            ...
                            <div class="media-body">
                                ...
                                The denser interior of the filler is surrounded by a softer layer of down/feather. This
                                ensures
                                optimal
                                support and reduces muscle tension in the neck and shoulders.
                                Double edging makes the pillow higher at the edges and provides free movement of the
                                filler.
                                This pillow is suitable for those who prefer to sleep on the side or on the back. High
                                and
                                dense
                                pillow
                                provides a comfortable support.
                                The pillow can be washed in a washing machine at 60 °C. At this temperature, dust mites
                                die.
                            </div>
                        </li>
                    </div>
                    ...
                    <div>
                        <li class="media" id="product6">
                            ...
                            <div class="media-body">
                                ...
                                <h4>9 999.–</h4>
                                Do you value every minute of your morning sleep? Get your clothes ready for tomorrow and
                                hang them
                                behind the mirror.
